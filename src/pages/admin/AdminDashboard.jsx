...
export default function AdminDashboard() {
  ...
  // Top level KPIs
  const metrics = [
    { name: 'Tổng người dùng', value: users.length + 1520, change: '+12.4% tháng này', icon: Users, color: 'text-blue-500 bg-blue-500/10 dark:text-blue-400 dark:bg-blue-500/10' },
    { name: 'Học viên active', value: 874, change: '+4.5% tuần này', icon: Clock, color: 'text-purple-500 bg-purple-500/10 dark:text-purple-400 dark:bg-purple-500/10' },
    { name: 'Hoàn thành Quiz', value: '81.5%', change: '+3.2% tăng trưởng', icon: Percent, color: 'text-emerald-500 bg-emerald-500/10 dark:text-emerald-400 dark:bg-emerald-500/10' },
    { name: 'Lượt hỏi AI Mentor', value: '1,420', change: '+24% tuần này', icon: MessageSquare, color: 'text-amber-500 bg-amber-500/10 dark:text-amber-400 dark:bg-amber-500/10' }
  ];

  // Chart 1: User Growth and Active users (Blue/Purple theme)
  const trafficData = [
    { name: 'T1', 'Đăng ký mới': 120, 'Hoạt động': 85 },
    { name: 'T2', 'Đăng ký mới': 180, 'Hoạt động': 130 },
    { name: 'T3', 'Đăng ký mới': 240, 'Hoạt động': 190 },
    { name: 'T4', 'Đăng ký mới': 310, 'Hoạt động': 250 },
    { name: 'T5', 'Đăng ký mới': 480, 'Hoạt động': 390 },
    { name: 'T6', 'Đăng ký mới': 620, 'Hoạt động': 510 },
  ];

  // Chart 2: Onboarding conversion funnel
  const funnelData = [
    { stage: '1. Truy cập', 'Tỷ lệ %': 100 },
    { stage: '2. Đăng ký', 'Tỷ lệ %': 88 },
    { stage: '3. Khảo sát rủi ro', 'Tỷ lệ %': 75 },
    { stage: '4. Học bài basics', 'Tỷ lệ %': 63 },
    { stage: '5. Premium upgrade', 'Tỷ lệ %': 14 }
  ];

  // Chart 3: Financial Personality breakdown
  const personalityDistribution = [
    { name: 'Blockchain Curious (52%)', value: 52 },
    { name: 'Balanced Builder (22%)', value: 22 },
    { name: 'Safe Saver (14%)', value: 14 },
    { name: 'High Growth Seeker (12%)', value: 12 }
  ];

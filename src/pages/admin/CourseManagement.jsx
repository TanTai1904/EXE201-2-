...
export default function CourseManagement() {
  ...
  const [lessons, setLessons] = useState([
    { title: 'Chương 1: Khởi động ngân sách', videoUrl: 'https://media.w3c.org/2010/05/sintel/trailer_hd.mp4', reading: 'Bài học mẫu...' }
  ]);
  ...
  const handleOpenCreate = () => {
    ...
    setDescription('');
    setLessons([{ title: 'Chương 1: Bài học nhập môn', videoUrl: 'https://media.w3c.org/2010/05/sintel/trailer_hd.mp4', reading: 'Nội dung đọc hiểu...' }]);
  ...
  const handleAddLessonField = () => {
    setLessons([...lessons, { title: '', videoUrl: 'https://media.w3c.org/2010/05/sintel/trailer_hd.mp4', reading: '' }]);
  };
                  ...
                  {courses.map((c) => (
                    <tr key={c.id} className="hover:bg-slate-100/30 dark:hover:bg-slate-900/10 transition-colors">
                      ...
                      <td className="p-3 text-right space-x-2">
                        ...
                        <button
                          onClick={() => { if (window.confirm('Xác nhận xóa khóa học này?')) deleteCourse(c.id); }}

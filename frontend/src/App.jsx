...
import RechartsLearning from './pages/learning/RechartsLearning';
  ...
  return (
    <Routes>
      ...
      <Route path="/" element={<Layout />}>
        ...
        <Route path="recharts-learning" element={<RechartsLearning />} />
        ...
        <Route path="admin/subscription-approvals" element={<SubscriptionApprovals />} />
      </Route>

...
export default function ProfileSetup() {
  ...
  const email = location.state?.email || 'hoanglam@gmail.com';
  const name = location.state?.name || 'Nguyễn Hoàng Lâm';
      ...
      <div className="w-full max-w-2xl bg-white/95 backdrop-blur-md rounded-3xl border border-slate-200/80 p-6 md:p-8 shadow-2xl relative z-10 fade-in">
        ...
        {step === 1 && (
          <form onSubmit={handleDemographicsNext} className="space-y-6">
            ...
            <button 
              type="submit"
              className="w-full py-3 rounded-xl bg-brand-teal text-white font-extrabold text-sm shadow-lg shadow-blue-500/20 hover:opacity-95 transition-all flex items-center justify-center space-x-1 cursor-pointer"
            >
          ...
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-2">
              ...
              <button 
                ...
                className="flex-1 py-3 px-4 rounded-xl bg-brand-teal text-white font-extrabold text-xs shadow-lg shadow-blue-500/20 hover:scale-[1.01] transition-all flex items-center justify-center space-x-1.5 cursor-pointer"
              >

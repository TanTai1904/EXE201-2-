        ...
        {step === 3 ? (
          ...
          <div className="space-y-4 text-center">
            ...
            <button 
              ...
              disabled={loading}
              className="w-full py-2.5 rounded-xl bg-brand-teal text-white font-bold text-sm shadow-lg shadow-teal-500/10 hover:opacity-90 transition-all cursor-pointer disabled:opacity-50"
            >
              {loading ? (
          ...
          <>
            {/* Form Header */}
            <div className="mb-6">
              <h1 className="text-xl font-extrabold tracking-tight bg-clip-text text-transparent bg-brand-teal">
                Khôi phục mật khẩu
              </h1>

      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div className="glass-panel p-4 rounded-xl border border-slate-200 dark:border-slate-800 text-center bg-brand-teal text-white">
            ...
            <div className="h-64 w-full">
              <ResponsiveContainer width="100%" height="100%">
                <LineChart data={chartData} margin={{ top: 10, right: 10, left: -10, bottom: 0 }}>
                  ...
                  <Line type="monotone" dataKey="Tiền gốc gửi" stroke="#94A3B8" strokeWidth={1.5} dot={false} />
                  <Line type="monotone" dataKey="Lãi kép tích lũy" name="Tổng tài sản (gốc + lãi kép)" stroke="#0F62FE" strokeWidth={2.5} dot={false} />
                </LineChart>
              </ResponsiveContainer>
            </div>
          </div>

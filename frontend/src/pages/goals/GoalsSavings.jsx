    ...
    <div className="space-y-6 fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          {goals.length === 0 ? (
            ...
            goals.map(goal => {
              ...
              return (
                <div 
                  key={goal.id} 
                  className={`glass-panel p-5 rounded-xl border transition-all ${isFinished ? 'border-brand-gold bg-amber-500/5' : 'border-slate-200 dark:border-slate-800'}`}
                >
        ...
        <div className="space-y-6">
          ...
          <div className="glass-panel p-5 rounded-xl border border-slate-200 dark:border-slate-800">
      ...
      {showAddModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-xs p-4">
          <div className="w-full max-w-md glass-panel p-6 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-2xl relative fade-in text-slate-850 dark:text-white">
            <button 
            ...
            <form onSubmit={handleCreateGoal} className="space-y-4">
              ...
              <button 
                type="submit"
                className="w-full py-2.5 bg-brand-teal text-white font-bold text-xs rounded-xl shadow-md transition-all cursor-pointer"
              >
                Tạo mục tiêu ngay
              </button>
            </form>
      ...
      {showDepositModal && selectedGoalForDeposit && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-xs p-4">
          <div className="w-full max-w-sm glass-panel p-6 rounded-xl border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-900 shadow-2xl relative fade-in text-slate-850 dark:text-white">
            <button 

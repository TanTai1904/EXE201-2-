...
export default function UserManagement() {
  const { users, blockUser, verifyUser, deleteUser } = useAuth();
  ...
  const handleEditSubmit = (e) => {
    e.preventDefault();
    // Simulate updating in context list
    editingUser.name = editName;
    editingUser.subscription = editSubscription;
    editingUser.riskProfile = editRisk === 'None' ? null : editRisk;
